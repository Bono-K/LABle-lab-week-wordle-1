...
const winMessages = [
  ...
  "Big DNA fragments are sheared into smaller, more manageable bite-sized pieces",
  "Copy Number Alteration is the number of copies of a certain gene in a sample. This data has no validated clinical use, so should be used for research purposes only!",
  "We process solid AND liquid tumors -- which is to say, solid tissue and blood-based tumors",
  "A type of DNA mutation charcterized by the insertion or deltion of DNA bases",
  "Our FoundationOneLiquid lab handles both fresh blood and frozen plasma",
  "FoundationOne solid extraction processes small and big tissue samples separately to improve quality",
]
